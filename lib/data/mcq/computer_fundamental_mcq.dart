...
const computerFundamentalMCQQuestions = [
  {
    "id": "cf_q1",
  ...
  },
  {
    ...
    "question":
        "Which type of RAM loses its contents when power is turned off?",
    "options": ["ROM", "PROM", "Volatile RAM", "EEPROM"],
    "correctIndex": 2,
    "explanation":
        "RAM (Random Access Memory) is volatile memory, meaning it loses all stored data when power is removed. This is in contrast to ROM (Read-Only Memory) and its variants (PROM, EPROM, EEPROM), which are non-volatile and retain data even without power. The volatile nature of RAM makes it suitable for temporary storage during program execution.",
    "difficulty": "easy",
  ...
  },
  {
    ...
    "question":
        "Which type of computer is specifically designed for complex scientific calculations and simulations?",
    "options": [
      "Mainframe computer",
      "Supercomputer",
      "Workstation",
    ...
    "correctIndex": 1,
    "explanation":
        "Supercomputers are the most powerful computers designed specifically for complex scientific calculations, weather forecasting, nuclear simulations, and other computationally intensive tasks. They can perform trillions of calculations per second (measured in FLOPS). While mainframes handle large-scale transaction processing and workstations are powerful desktop computers, supercomputers are in a class of their own for raw computational power.",
    "difficulty": "easy",
  ...
  },
  {
    ...
    "correctIndex": 1,
    "explanation":
        "The Program Counter (PC) holds the memory address of the next instruction to be fetched and executed. After each instruction fetch, the PC is automatically incremented to point to the next sequential instruction. This allows the CPU to execute instructions in sequence. The Current Instruction Register (CIR) holds the current instruction, the Accumulator (ACC) stores arithmetic results, and the Memory Address Register (MAR) holds the address being accessed.",
    "difficulty": "medium",
  ...
  },
  {
    ...
    "question":
        "In the Fetch-Decode-Execute cycle, what happens during the Fetch stage?",
    "options": [
    ...
    "correctIndex": 1,
    "explanation":
        "During the Fetch stage, the CPU retrieves the instruction from memory at the address specified by the Program Counter (PC) and loads it into the Current Instruction Register (CIR). The PC is then incremented to point to the next instruction. The Decode stage interprets the instruction, and the Execute stage carries out the instruction's operation. This cycle repeats continuously during program execution.",
    "difficulty": "easy",
  ...
  },
  {
    ...
    "subTopicId": "risc",
    "question":
        "Which characteristic is typical of RISC (Reduced Instruction Set Computer) architecture?",
    "options": [
  ...
  },
  {
    ...
    "question":
        "Which cache level is typically the fastest but smallest in size?",
    "options": ["L3 Cache", "L2 Cache", "L1 Cache", "L4 Cache"],
    "correctIndex": 2,
    "explanation":
        "L1 (Level 1) cache is the fastest cache memory but also the smallest, typically ranging from 32KB to 128KB per core. It is located closest to the CPU core and has the lowest latency. L2 cache is larger but slower than L1, and L3 cache is even larger but slower still. The cache hierarchy follows the principle that faster memory is more expensive and therefore smaller, while slower memory can be larger and less expensive.",
    "difficulty": "easy",
  ...
  },
  {
    ...
    "question":
        "What technological advancement characterized third-generation computers?",
    "options": [
      "Vacuum tubes",
      "Transistors",
  ...
  },
  {
    ...
    "correctIndex": 2,
    "explanation":
        "SRAM (Static RAM) is significantly faster than DRAM (Dynamic RAM) because it doesn't require constant refreshing. SRAM uses flip-flops to store each bit, allowing for immediate access. However, SRAM is more expensive, has lower storage density (requires more transistors per bit), and consumes more power. This is why SRAM is used for cache memory where speed is critical, while DRAM is used for main memory where capacity and cost are more important.",
    "difficulty": "medium",
  ...
  },
  {
    ...
    "correctIndex": 2,
    "explanation":
        "The correct boot sequence is: 1) BIOS/UEFI firmware initializes when power is applied, 2) POST (Power-On Self-Test) checks hardware components, 3) BIOS locates and loads the bootloader from the boot device, 4) Bootloader loads the operating system into memory, 5) OS initializes and presents the user login screen. This sequence ensures that hardware is functioning properly before attempting to load the operating system.",
    "difficulty": "medium",
  ...
  },
  {
    ...
    "correctIndex": 1,
    "explanation":
        "Firmware is software that is permanently or semi-permanently stored in hardware devices, typically in ROM, EPROM, or flash memory. It provides low-level control for the device's specific hardware and is essential for the device to function. Examples include BIOS/UEFI, router firmware, and embedded system software. Unlike regular software, firmware is not easily modified by users and sits between hardware and software, providing the interface between them. It can be updated but requires special procedures.",
    "difficulty": "medium",
  ...
  },
  {
    ...
    "correctIndex": 1,
    "explanation":
        "Standard ASCII (American Standard Code for Information Interchange) uses 7 bits to represent characters, allowing for 128 different characters (2^7 = 128). These include uppercase and lowercase letters, digits, punctuation marks, and control characters. Extended ASCII uses 8 bits (1 byte) for 256 characters. Unicode, which includes ASCII as a subset, uses 16 or more bits to represent characters from multiple languages and symbol sets worldwide.",
    "difficulty": "medium",
  ...
  },
  {
    ...
    "question":
        "Which statement correctly distinguishes primary memory from secondary memory?",
    "options": [
  ...
  },
  {
    ...
    "question":
        "What is the primary purpose of the Accumulator (ACC) register?",
    "options": [
  ...
  },
  {
    ...
    "correctIndex": 2,
    "explanation":
        "The control bus carries control and timing signals that coordinate and manage the operations of the computer system. These signals include read/write commands, clock signals, interrupt requests, bus request/grant signals, and reset signals. The control bus is bidirectional and ensures that data transfers occur at the right time and in the right direction. It works in conjunction with the address bus (which carries addresses) and data bus (which carries data) to enable proper system operation.",
    "difficulty": "medium",
  ...
  },
  {
    ...
    "question":
        "What distinguishes a workstation from a regular personal computer?",
    "options": [
  ...
  },
  {
    ...
    "options": ["Static", "Synchronous", "Sequential", "Secure"],
    "correctIndex": 1,
    "explanation":
        "SDRAM stands for Synchronous Dynamic RAM. The 'synchronous' means that the RAM is synchronized with the system clock, allowing the memory controller to know exactly when requested data will be ready. This synchronization improves performance compared to asynchronous DRAM. SDRAM operates in sync with the CPU's bus clock, enabling faster and more efficient data transfers. DDR (Double Data Rate) SDRAM is an evolution that transfers data on both clock edges.",
    "difficulty": "medium",
  ...
  },
  {
    ...
    "correctIndex": 1,
    "explanation":
        "During the Decode stage, the Control Unit interprets the instruction that was fetched and loaded into the Current Instruction Register (CIR). The CU determines what operation needs to be performed, what operands are required, and which components of the CPU need to be activated. It breaks down the instruction into signals that control the various parts of the CPU. After decoding, the Execute stage carries out the actual operation specified by the instruction.",
    "difficulty": "easy",
  ...
  },
  {
    ...
    "correctIndex": 2,
    "explanation":
        "HDMI (High-Definition Multimedia Interface) transmits both high-definition video and audio signals digitally through a single cable. This eliminates the need for separate audio and video cables. HDMI supports various video resolutions including 4K and 8K, multiple audio channels, and additional features like Ethernet connectivity and device control. It has largely replaced older analog connections like VGA (video only) and composite cables in modern devices.",
    "difficulty": "easy",
  ...
  },
  {
    ...
    "question":
        "Why is cache memory organized in multiple levels (L1, L2, L3)?",
    "options": [
  ...
  },
  {
    ...
    "question":
        "What was the main advantage of transistors over vacuum tubes in second-generation computers?",
    "options": [
  ...
  },
  {
    ...
    "question":
        "Which scenario would benefit MOST from a multi-core processor?",
    "options": [
    ...
    "correctIndex": 2,
    "explanation":
        "Video rendering with parallel processing support would benefit most from a multi-core processor because it can divide the rendering task across multiple cores, with each core processing different frames or portions of the video simultaneously. This type of workload is highly parallelizable. Single-threaded applications, simple websites, and basic programs cannot take advantage of multiple cores effectively as they execute sequentially on a single core. Multi-core processors excel at multitasking and applications specifically designed for parallel processing.",
    "difficulty": "hard",
